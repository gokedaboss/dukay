...
export default function Home() {
  ...
  const handleAnalyze = async () => {
    ...
    if (!trimmedUrl) {
      setError("Paste a social post link first.");
      return;
    }

    if (!isSupportedUrl(trimmedUrl)) {
      setError("Please paste a supported link — Instagram, TikTok, YouTube, X, Facebook, Reddit or LinkedIn.");
      return;
    }
  ...
  return (
    <main className="min-h-screen bg-[#111111] text-white font-sans">
      ...
      <section className="flex flex-col items-center text-center px-5 pt-28 pb-16">
        ...
        <section className="max-w-xl mx-auto px-5 pb-24 space-y-3">
          ...
          <div className="relative rounded-2xl overflow-hidden">
            ...
            <div className="absolute inset-0 backdrop-blur-md bg-[#111111]/70 flex flex-col items-center justify-center gap-2 rounded-2xl py-6">
              ...
              <p className="text-white/40 text-xs text-center px-10 leading-relaxed">
                Unlock deeper reasoning, comment patterns, saved analyses, and post Q&A.
              </p>
